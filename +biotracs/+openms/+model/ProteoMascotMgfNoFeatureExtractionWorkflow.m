% BIOASTER
%> @file		ProteoMascotMgfNoFeatureExtractionWorkflow.m
%> @class		biotracs.openms.model.ProteoMascotMgfNoFeatureExtractionWorkflow
%> @link		http://www.bioaster.org
%> @copyright	Copyright (c) 2014, Bioaster Technology Research Institute (http://www.bioaster.org)
%> @license		BIOASTER
%> @date		2017

classdef ProteoMascotMgfNoFeatureExtractionWorkflow <biotracs.core.mvc.model.Workflow
    ...
    methods
        % Constructor
        function this = ProteoMascotMgfNoFeatureExtractionWorkflow( )
