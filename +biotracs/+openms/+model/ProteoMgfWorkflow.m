% BIOASTER
%> @file		ProteoMgfWorkflow.m
%> @class		biotracs.openms.model.ProteoMgfWorkflow
%> @link		http://www.bioaster.org
%> @copyright	Copyright (c) 2014, Bioaster Technology Research Institute (http://www.bioaster.org)
%> @license		BIOASTER
%> @date		2018

classdef ProteoMgfWorkflow <biotracs.core.mvc.model.Workflow
    ...
    methods
        % Constructor
        function this = ProteoMgfWorkflow( )
    ...
    methods(Access = protected)
        ...
        function [ featuresLinkingWorkflow ] = doFeatureLinkingWorkflow(this)
            ...
            featuresLinkingWorkflow.createOutputPortInterface( 'ConsensusMapNormalizer', 'DataFileSet' );
        end
        ...
        function this = doConnectWorkflows(this)
            ...
            mgfConvertingWorkflow.getOutputPort('RtFileFilter:DataFileSet').connectTo( peptideIdentificationWorkflow.getInputPort('XTandemAdapter:DataFileSet') );
            ...
            featuresLinkingWorkflow.getOutputPort('ConsensusMapNormalizer:DataFileSet').connectTo( proteinQuantifyingWorkflow.getInputPort('ProteinQuantifier:FeatureFileSet') );
        end
    end
