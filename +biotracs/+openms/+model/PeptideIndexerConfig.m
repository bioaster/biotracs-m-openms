...
classdef PeptideIndexerConfig < biotracs.openms.model.BaseProcessConfig
    ...
    methods
        ...
        function this = PeptideIndexerConfig( )
            ...
            this.createParam('MaximalNbAmbiguousAA',  4, ...
                'Constraint', biotracs.core.constraint.IsPositive( 'Type', 'integer'),...
                'Description', 'Maximal number of ambiguous acids (AAAS) allowed when matching to a protein database with AAAs. AAAs are B, J, Z and X. (default: 3)');
          ...
          this.createParam ('Enzyme', 'Trypsin', ...
            ...
            this.optionSet.addElements(...
                ...
                'MaximalNbAmbiguousAA'  ,  biotracs.core.shell.model.Option('-aaa_max "%g"'), ...
