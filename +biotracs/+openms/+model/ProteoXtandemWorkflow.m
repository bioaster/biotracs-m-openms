% BIOASTER
%> @file		ProteoXtandemWorkflow.m
%> @class		biotracs.openms.model.ProteoXtandemWorkflow
%> @link		http://www.bioaster.org
%> @copyright	Copyright (c) 2014, Bioaster Technology Research Institute (http://www.bioaster.org)
%> @license		BIOASTER
%> @date		2016

classdef ProteoXtandemWorkflow <biotracs.core.mvc.model.Workflow
    ...
    methods
        % Constructor
        function this = ProteoXtandemWorkflow( )
    ...
    methods(Access = protected)
        ...
        function [ peptideIdentificationWorkflow ] = doPeptideIdentificationWorkflow(this)
            peptideIdentificationWorkflow = biotracs.openms.model.PeptideIdentificationXtandemWorkflow();
