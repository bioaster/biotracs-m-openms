%"""
%Unit tests for biotracs.openms.model.MascotAdapterOnline
%* License: BIOASTER License
%* Created: 2017
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testMascotAdapterOnline( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/MascotAdapterOnlineTests.m');
    Tests.run();
end