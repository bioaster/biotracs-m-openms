%"""
%Unit tests for biotracs.openms.model.FalseDiscoveryRate
%* License: BIOASTER License
%* Created: 2016
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testFalseDiscoveryRate( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/FalseDiscoveryRateTests.m');
    Tests.run;
end