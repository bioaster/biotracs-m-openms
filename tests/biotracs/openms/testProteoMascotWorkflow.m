%"""
%Unit tests for biotracs.openms.model.ProteoMascotWorkflow
%* License: BIOASTER License
%* Created: 2017
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testProteoMascotWorkflow( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/ProteoMascotWorkflowTests.m');
    Tests.run();
end