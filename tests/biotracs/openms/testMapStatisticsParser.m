%"""
%Unit tests for biotracs.openms.model.MapStatisticsParser
%* License: BIOASTER License
%* Created: 2017
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testMapStatisticsParser( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/MapStatisticsParserTests.m');
    Tests.run();
end