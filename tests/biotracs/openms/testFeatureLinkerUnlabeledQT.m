%"""
%Unit tests for biotracs.openms.model.FeatureLinkerUnlabeledQT
%* License: BIOASTER License
%* Created: 2016
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testFeatureLinkerUnlabeledQT( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/FeatureLinkerUnlabeledQTTests.m');
    Tests.run();
end