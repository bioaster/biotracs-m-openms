%"""
%Unit tests for biotracs.openms.model.FeatureFinderMetabo
%* License: BIOASTER License
%* Created: 2014
%Bioinformatics team, Omics Hub, BIOASTER Technology Research Institute (http://www.bioaster.org)
%"""

function testFeatureFinderMetabo( cleanAll )
    ...
    Tests = TestSuite.fromFile('./model/FeatureFinderMetaboTests.m');
    Tests.run;
